...
internal static class Program
{
    public static void Main(string[] args)
    {
        ...
        var resources = "/home/vas/Downloads/Sprites/BB";
        var result = "../Result/B&B";
        ...
        switch (type.ToLower())
        {
            case "allods":
                ...
                break;
            case "b&b":
                FileFactory = BeastsAndBumpkinsParserConfigurator.FileFactory;
                FileConverters = BeastsAndBumpkinsParserConfigurator.FileConverters(result);
                break;
            default:
