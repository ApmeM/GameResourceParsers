...
public class M10ToWavConverter : BaseFileConverter<BinaryFile>
{
    protected override IEnumerable<BaseFile> ConvertFile(BinaryFile toConvert, List<BaseFile> files)
    {
        if (!toConvert.relativeFileExtension.Contains("M10", StringComparison.InvariantCultureIgnoreCase))
        {
